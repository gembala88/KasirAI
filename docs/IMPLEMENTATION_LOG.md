...
Phase-by-phase build history: what was built, why, exact commands, and the
live-verification evidence for each phase. This is the detailed technical
record — for the project overview, architecture summary, and new-client
setup instructions, see [README.md](../README.md) at the repo root instead.
...
spec for architecture, data model, and roadmap — this log only covers
