 ...
 * rarely-changing lookup lists (Item Groups, UOMs, Warehouses), unlike
 * the product catalog's own dedicated store (spec §15.3), so the heavier
 * machinery isn't warranted here. Shared by TambahProdukBaru and
 * WarehouseScan, which both need a Gudang list.
 */
